      ...
      child: Padding(
        ...
        child: Row(
           children: [
                  ...
                  Expanded(flex:5, child: Text('Soyisim', style: Theme.of(context).textTheme.bodyMedium, overflow: TextOverflow.ellipsis)),
                  const Expanded(child: Icon(Iconsax.arrow_right_3, size: 18)),
                ]
              )
        )
